                    ...
                    <div class="social">
                        <a href="">
                            <svg class="icon" title="check us out on facebook">
                                <use xlink:href="/node_modules/feather-icons/dist/feather-sprite.svg#facebook"/>
                            </svg>
                        </a>
                        
                        <a href="" title="check out our instagram">
                            <svg class="icon">
                                <use xlink:href="/node_modules/feather-icons/dist/feather-sprite.svg#instagram"/>
                            </svg>
                        </a>
                    </div>
                </div>
        ...
        <script src="/js/masonry_grid.js"></script>

        <!-- Login Form Validation Starter -->
        ...
        <!-- custom site scripts and initializations -->
