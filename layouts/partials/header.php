                ...
                <nav id="primary" class="navbar navbar-dark bg-primary navbar-expand-lg">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="/pages/our-restaurants.php">View all reastaurants</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a href="/pages/give.php" class="nav-link">Buy a card, Give a meal</a>
                                </li>
                            </ul>
                            <form id="site_search--container" class="form-inline">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Where are we eating?" aria-label="restaurant search">
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="button" aria-label="search">
                                        <svg class="icon">
                                            <use xlink:href="/node_modules/feather-icons/dist/feather-sprite.svg#search"/>
                                        </svg>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <a href="/pages/login.php" class="btn btn-link">Sign In</a>
                            
                            <a href="/pages/purchase.php" class="btn btn-primary">
                                Buy Now
