...
?>
<main class="content">
    <section id="homeHero" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <article class="carousel-item active">
                <div class="carousel-image">
                    <img class="d-block" src="/images/hero-photo.jpg" alt="First slide">
                </div>
                <div class="container">
                    <div class="carousel-text">
                        <h1 class="display-2">Dine out with purpose</h1>
                        <p>For just $29.99 a year, you can save 10% at participating restaurants while helping those in need</p>
            ...
            <!-- <article class="carousel-item">
                <div class="carousel-image">
                    <img class="d-block" src="/images/hero-photo.jpg"  alt="Second slide">
                </div>
            </article>
            <article class="carousel-item">
                <div class="carousel-image">
                    <img class="d-block" src="/images/hero-photo.jpg"  alt="Third slide">
                </div>
            </article> -->
        </div>
    ...
    <section id="featuredRestaurants" class="container">
    ...
    <section id="giveAMeal">
        <img class="give-bg" src="/images/photo-collection.jpg" />

        <div class="give-container container">
            <div class="give-logo">
